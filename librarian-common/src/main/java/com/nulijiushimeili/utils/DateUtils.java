package com.nulijiushimeili.utils;
...
public class DateUtils {
     ...
     */
    @Nullable
    public static String format(Date date, TimeZone timeZone, String patten) {
        if (date == null) {
            return null;
        }
    ...
    public static String getPointTimePattern(Integer year, Integer month, Integer day, Integer hour, Integer minute, Integer seconds, String patten) {
        DateTime dt = new DateTime(year, month, day, hour, minute, seconds);
        String date = dt.toString(patten);
        return date;
    }
     ...
     * @return
     */
    public static String getPointDatParrten(Integer year, Integer month, Integer day, String patten) {
        LocalDate dt = new LocalDate(year, month, day);
        String date = dt.toString(patten);
        return date;
    }
